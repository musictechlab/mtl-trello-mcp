# Contributing to mtl-trello-mcp
...
1. Check existing [issues](https://github.com/musictechlab/mtl-trello-mcp/issues)
   to avoid duplicates
...
Open a [discussion](https://github.com/musictechlab/mtl-trello-mcp/discussions)
